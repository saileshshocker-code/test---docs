...
const Headersearch = document.querySelector(".search-box");
const InsertAt = document.querySelector(".flex-fill");
Headersearch.insertAdjacentElement('afterbegin', InsertAt);